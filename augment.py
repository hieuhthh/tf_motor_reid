...
if __name__ == '__main__':
    ...
    sample_inp = '/home/minint-t14g3hk-local/hieunmt/tf_motor_reid/unzip/MoRe_Dataset/pair01/camA/camA_id_03578_num_001.png'

    img = cv2.imread(sample_inp)
    cv2.imwrite("sample_inp.png", img)

    if im_size_before_crop is not None:
        img = cv2.resize(img, (im_size_before_crop, im_size_before_crop))
